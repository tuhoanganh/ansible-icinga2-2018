System.register(["lodash", "../../../core/utils/flatten", "../../../core/time_series2", "../../../core/table_model"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_lodash) {
      _ = _lodash.default;
    }, function (_coreUtilsFlatten) {
      flatten = _coreUtilsFlatten.default;
    }, function (_coreTime_series) {
      TimeSeries = _coreTime_series.default;
    }, function (_coreTable_model) {
      TableModel = _coreTable_model.default;
    }],
    execute: function () {
      ...
      transformers['table'] = {
        ...
        transform: function (data, panel, model) {
          ...
          if (data[0].type !== 'table') {
            throw {
              message: 'Query result is not in table format, try using another transform.'
            };
          }
